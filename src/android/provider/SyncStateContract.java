...
public class SyncStateContract {
	...
	// private static final String[] DATA_PROJECTION = new
	// String[]{Columns.DATA, Columns._ID};
	...
	// communicate
	// * with the {@link android.content.ContentProvider} that contains the sync
	// state.
	// * @param uri the uri of the sync state
	// * @param account the {@link Account} whose sync state should be returned
	// * @return the sync state or null if there is no sync state associated
	// with the account
	// * @throws RemoteException if there is a failure communicating with the
	// remote
	...
	// }
	//
	// public static void update(ContentProviderClient provider, Uri uri, byte[]
	// data)
	...
	// * @param account the {@link Account} whose sync state should be set
	// * @param data the byte[] that contains the sync state
	// * @return the new ContentProviderOperation that assigns the data array as
	// the
	...
	// * account's sync state
	// */
	// public static ContentProviderOperation newUpdateOperation(Uri uri, byte[]
	// data) {
	// ContentValues values = new ContentValues();
	// values.put(Columns.DATA, data);
	// return ContentProviderOperation
